               ...
               <CardWrapper1>
                    <div className="text-left text-inter ">
                         ...
                         <div>
                              <ul
                                   className={
                                        'list-disc list-inside  ' + cardNormal
                                   }
                              >
                                   <li className="relative hover-item hover:text-[#990011]">
                                        ...
                                        <div className="hover-box">
                                             ...
                                             August 25th from 6 PM to 8 PM. Meet
                                             teachers, explore classrooms, and
                                             learn about the exciting year
                                             ahead!
                                        </div>
                                   </li>
                                   <li className="relative hover-item hover:text-[#990011]">
                                        ...
                                        <div className="hover-box">
                                             ...
                                             until August 20th. Sign up for
                                             football, soccer, volleyball, and
                                             cross country. Visit the athletics
                                             page for details.
                                        </div>
                                   </li>
                                   <li className="relative hover-item hover:text-[#990011]">
                                        ...
                                        <div className="hover-box">
                                             ...
                                             September 10th. Ensure your child
                                             is dressed appropriately. Order
                                   ...
                                   <li className="relative hover-item hover:text-[#990011]">
                                        ...
                                        <div className="hover-box">
                                             ...
                                             will be held on September 5th at 7
                                             PM in the school library. All
