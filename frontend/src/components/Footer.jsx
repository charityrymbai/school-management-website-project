    ...
    return (
        <div className="text-montserrat flex justify-center h-fit w-full bg-blue-900 bottom-0">
            <div className="text-gray-200 w-full p-5 grid grid-cols-2 sm:w-[600px] sm:grid-cols-3">
                <div>
                    <h1 className="text-sm text-center sm:text-lg font-bold">Contact</h1>
                ...
                <div>
                    <h1 className="text-sm sm:text-lg text-center font-bold" >Social</h1>
                ...
                <div>
                    <h1 className="text-sm sm:text-lg text-center font-bold">Useful links</h1>
                    <ul className="text-xs sm:text-base list-none pl-0 text-center">
                        <li>Downloads</li>
                        <li>Announcements</li>
                    </ul>
