...
function Header() {
    ...
    const fontSize = Math.max(
        screenWidth < 650 ? 1 : 1.5,
        (screenWidth < 768 ? 2 : 3) - scrollY / 100,
    );
    ...
    return (
        ...
        >
            <div className="h-full flex justify-center items-center bg-gradient-to-r from-sky-500 to-indigo-500 p-2">
                <div>
                    <img
                        style={{
                            width: `${imageWidth}px`,
